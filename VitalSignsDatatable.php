...
class VitalSignsDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'doctors.VitalSigns_table.btn.checkbox')
            ->addColumn('edit', 'doctors.VitalSigns_table.btn.edit')
            ->addColumn('delete', 'doctors.VitalSigns_table.btn.delete') 
            ->rawColumns([
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons'=>[
                            ['text'=>'<i class="fa fa-plus"></i> ' .trans('doctors.create_vitalsigns'),
    ...
    protected function getColumns()
    {
        return [
                    ...
                    [
                        'name'      =>'length',
                        'data'      =>'length',
                        'title'     =>trans('doctors.length'),
                    ],
                    [
                        'name'      =>'size',
                        'data'      =>'size',
                        'title'     =>trans('doctors.size'),
                    ],
                    [
                        'name'      =>'temperature',
                        'data'      =>'temperature',
                        'title'     =>trans('doctors.temperature'),
                    ],
                  /*   [
                        'name'      =>'birth_of_date',
                        'data'      =>'birth_of_date',
