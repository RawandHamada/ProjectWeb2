...
class DoctorsDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'doctors.doctors_table.btn.checkbox')
            ->addColumn('edit', 'doctors.doctors_table.btn.edit')
            ->addColumn('delete', 'doctors.doctors_table.btn.delete')
            ->rawColumns([
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons'=>[
                            ['text'=>'<i class="fa fa-plus"></i> ' .trans('doctors.create_doctors'),
    ...
    protected function getColumns()
    {
        return [
                    ...
                    [
                        'name'      =>'name',
                        'data'      =>'name',
                        'title'     =>trans('doctors.name_doctor'),
                    ],
                    [
                        'name'      =>'email',
                        'data'      =>'email',
                        'title'     =>trans('doctors.email_doctor'),
                    ],
                    [
                        'name'      =>'created_at',
                        'data'      =>'created_at',
